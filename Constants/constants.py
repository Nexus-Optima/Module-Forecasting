...
correlation_methods = [evaluate_correlation_analysis, evaluate_tree_based_models,
                       evaluate_spearman_correlation_analysis, evaluate_recursive_feature_elimination]
